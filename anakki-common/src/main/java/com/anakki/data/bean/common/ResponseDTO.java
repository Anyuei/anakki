...
import com.anakki.data.bean.constant.ResponseCodeConst;
...
public class ResponseDTO<T> {
    ...
    public static <T> ResponseDTO<T> errorData(T data, String msg) {
        return new ResponseDTO(ResponseCodeConst.ERROR_PARAM, data, msg);
    }
